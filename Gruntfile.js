module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      standalone: {
        command: 'component build --standalone toString -n to-string.standalone'
      },
      mkdir: {
        command: 'mkdir -p dist'
      },
      move: {
        command: 'mv build/to-string.standalone.js dist/to-string.js'
      },
      remove: {
    ...
    uglify: {
      target: {
        files: {
          'dist/to-string.min.js': ['dist/to-string.js']
        }
      }
    },
    mocha: {
